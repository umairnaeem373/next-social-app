...
import { Send, MoreVertical, Search, Phone, Video, Paperclip, Smile, Menu, ArrowLeft, Sun, Moon } from 'lucide-react';
...
export default function ChatApp() {
  ...
  return (
    <div className={`flex h-screen relative ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      {/* Mobile Overlay */}
      {sidebarOpen && (
        <div 
      ...
      `}>
        ...
        <div className={`p-4 md:p-6 border-b ${darkMode ? 'border-gray-700' : 'border-gray-100'}`}>
          <div className="flex items-center justify-between mb-4">
            <h1 className={`text-xl font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Messages</h1>
          ...
          {contacts.map((contact) => (
            <div
              ...
              className={`p-3 md:p-4 border-b cursor-pointer transition-colors ${
                contact.active 
                  ? `border-l-4 border-l-blue-500 ${darkMode ? 'bg-gray-700/50' : 'bg-blue-50'}` 
              ...
              <div className="flex items-center space-x-3">
                <div className="relative">
                  {contact.avatar ? (
                    ...
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-full ${getAvatarColor(contact.name)} flex items-center justify-center text-white font-medium text-sm md:text-base`}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>{contact.timestamp}</span>
                  </div>
      ...
      <div className="flex-1 flex flex-col md:ml-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-green-500">Active now</p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-3 md:space-y-4">
          {messages.map((msg) => (
            ...
            >
              <div className={`flex items-end space-x-2 max-w-[85%] sm:max-w-xs md:max-w-md ${msg.sender === 'me' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                {msg.sender === 'other' && (
                  <div className="flex-shrink-0">
                    {msg.avatar ? (
                      ...
                      <div className={`w-6 h-6 md:w-8 md:h-8 rounded-full ${getAvatarColor(msg.senderName || 'User')} flex items-center justify-center text-white font-medium text-xs md:text-sm`}>
                ...
                <div>
                  ...
                  <p className={`text-xs mt-1 ${msg.sender === 'me' ? 'text-right' : 'text-left'} ${
